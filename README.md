...
[![Version](https://vsmarketplacebadges.dev/version/mattjs07.chordpro-vscode.png)](https://marketplace.visualstudio.com/items?itemName=mattjs07.chordpro-vscode)
[![Installs](https://vsmarketplacebadges.dev/installs/mattjs07.chordpro-vscode.png)](https://marketplace.visualstudio.com/items?itemName=mattjs07.chordpro-vscode)
